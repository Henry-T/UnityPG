...
namespace NPOI.HSSF.Util
{
    ...
    public class NameType
    {
        ...
        public static int NAMED_RANGE = 2;
        public static int COLUMN = 3;
        public static int BAD_CELL_OR_NAMED_RANGE = -1;
    }
    ...
    public class CellReference
    {
         ...
         */
        private static string NAMED_RANGE_NAME_PATTERN = "^[_A-Za-z][_A-Za-z0-9]*";
        ...
        private static int ValidateNamedRangeName(String str)
        {
            ...
            if (colMatcher.IsMatch(str))
            {
                ...
                if (IsColumnWithnRange(colStr.Value))
                {
         ...
         */
        public static bool CellReferenceIsWithinRange(String colStr, String rowStr)
        {
        ...
        public static bool IsColumnWithnRange(String colStr)
        {
            ...
            if (numberOfLetters == BIFF8_LAST_COLUMN_TEXT_LEN)
            {
                if (colStr.ToUpper().CompareTo(BIFF8_LAST_COLUMN) > 0)
                {
                    return false;
                }
            }
