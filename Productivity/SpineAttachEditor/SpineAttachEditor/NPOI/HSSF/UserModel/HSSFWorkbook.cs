...
namespace NPOI.HSSF.UserModel
{
    ...
    public class HSSFWorkbook : POIDocument,IDisposable,NPOI.SS.UserModel.Workbook
    {
        ...
        public int GetSheetIndex(NPOI.SS.UserModel.Sheet sheet)
        {
        ...
        public NPOI.SS.UserModel.Sheet CreateSheet()
        {
        ...
        public NPOI.SS.UserModel.Sheet CloneSheet(int sheetIndex)
        {
